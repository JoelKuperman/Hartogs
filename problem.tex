...
We shall use $\esti$ to denote $\estf$ with the Weak Axiom of Infinity and I to mean the Axiom of Infinity in its usual formulation.
Note that it is consistent with ZC$-$I for an infinite well order to exist and for the Axiom of Infinity to fail (\cite[Exercise II.4.21]{Kunen} gives one such model), in particular $\esti+\neg \text{I}$ is consistent.
