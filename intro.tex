...
Moreover we will show that not only can this sequence not exist as a set, it cannot even be defined in the metatheory.
...
\]
where $A \leq_c B$ means that there is an injection from $A$ to $B$.

Finally, we shall prove that the theorem fails if we allow infinitely many
