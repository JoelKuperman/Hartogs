...
This motivates the following result about decreasing sequences of cardinals: in ZF, it is possible to construct infinitely decreasing sequences of sets, when compared with the cardinality relation, but it is not possible to do so in such a way that
\[
...
In this article we present a proof of the above fact about decreasing sequences of cardinals without using the Replacement axiom, motivated by the discussion in \cite{PedroStack}.